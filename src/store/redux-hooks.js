...
export const useGitHubLoading = createSelector(
  ...
  (github) => ({
    ...
    processingAI: github.isProcessingAI, // Added AI processing loading state
    // 'details' was not in githubSlice initialState, removed if not used
...
export const useMemoizedSelector = (selector) => {
  ...
  return createMemoizedSelector(selector)(state);
};