...
export const generateProjectSummary = async (name, description, technologies) => {
  ...
  return `This project, "${name}," is a ${technologies || 'software'} solution aimed at ${description.substring(0, Math.min(description.length, 50))}... Its core features address [key features].`;
};
